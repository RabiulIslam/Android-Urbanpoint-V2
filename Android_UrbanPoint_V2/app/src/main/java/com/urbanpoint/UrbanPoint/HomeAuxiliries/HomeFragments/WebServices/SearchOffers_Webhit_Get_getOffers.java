...
public class SearchOffers_Webhit_Get_getOffers {
    private AsyncHttpClient mClient = new AsyncHttpClient();
    public static ResponseModel responseObject;
    public Context mContext;

    public void requestSearchOffers(Context _context, final IWebCallbacks iWebCallbacks, int _page, String _searchKey) {
...
//                                AppConfig.getInstance().navtoLogin();
    ...
    public class ResponseModel {
        ...
        public class Datum
        {
            ...
            public String getCategoryImage() { return this.category_image; }
