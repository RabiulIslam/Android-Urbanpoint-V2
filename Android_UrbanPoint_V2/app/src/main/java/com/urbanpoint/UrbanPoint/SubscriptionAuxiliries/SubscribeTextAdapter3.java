...
public class SubscribeTextAdapter3 extends BaseAdapter {
    Context context;
    List<String> listData;
    LayoutInflater inflter;
    boolean showCircle;

    public SubscribeTextAdapter3(Context _context, List<String> _listData, boolean _showCircle) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflter.inflate(R.layout.adpter_subscribe_text_list_items_3, null);
