...
public class Notification_Webhit_POST_readNotification {

    private AsyncHttpClient mClient = new AsyncHttpClient();
    public static ResponseModel responseObject;
    private Context mContext;

    public void readNotification(Context _context, final IWebCallbacks iWebCallbacks, String id) {

        String myUrl = AppConstt.BASE_URL_MOBILE + ApiMethod.POST.readNotification;
        ...
        mClient.post(myUrl, params, new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                        ...
                        try {
                            ...
                            Log.d("hdfjsadfladfj", "onSuccess: " + strResponse);
                            switch (statusCode) {
                                case AppConstt.ServerStatus.OK:
                                    iWebCallbacks.onWebResult(true, responseObject.getData().getId() + "");
                                    break;
                    ...
                    public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable
                            error) {
                        Log.d("hdfjsadfladfj", "onFailure: " + error.getMessage());
                        switch (statusCode) {
...
//                                AppConfig.getInstance().navtoLogin();
                            ...
                            default:
                                try {
                                    ...
                                    responseObject = gson.fromJson(strResponse, ResponseModel.class);
                                    Log.d("hdfjsadfladfj", "onFailure: " + strResponse);
                                    iWebCallbacks.onWebResult(false, responseObject.getMessage());
