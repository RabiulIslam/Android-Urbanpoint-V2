...
public class Subscribe_WebHit_Post_validatemsisdn {
    ...
    public void requestValidateMsisdn(Context _mContext, final IWebCallbacks iWebCallback,
                                      final String _phone) {

        this.mContext = _mContext;
        String myUrl = AppConstt.BASE_URL_SUBSCRIPTION + ApiMethod.POST.validatemsisdn;
