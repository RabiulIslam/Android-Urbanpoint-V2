...
public class OfferDetail_Webhit_POST_addFavouriteOffer {

    private AsyncHttpClient mClient = new AsyncHttpClient();
    public static ResponseModel responseObject;
    private Context mContext;

    public void requestAddToFav(Context _context, final IWebCallbacks iWebCallbacks, int id) {

        String myUrl = AppConstt.BASE_URL_MOBILE + ApiMethod.POST.addFavouriteOffer;
