...
public class UnSubscribe_Webhit_Post_unsubscribe {
    private AsyncHttpClient mClient = new AsyncHttpClient();
    public static ResponseModel responseObject;
    public Context mContext;

    public void requestUnSubsribe(Context _context, final IWebCallbacks iWebCallbacks, String _phone) {

        String myUrl = AppConstt.BASE_URL_SUBSCRIPTION + ApiMethod.POST.unsubscribe;
