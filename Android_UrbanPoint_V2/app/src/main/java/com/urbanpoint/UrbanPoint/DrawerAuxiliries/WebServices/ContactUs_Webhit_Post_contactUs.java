...
public class ContactUs_Webhit_Post_contactUs {
    private AsyncHttpClient mClient = new AsyncHttpClient();
    public static ResponseModel responseObject;
    public Context mContext;

    public void requestContactUs(Context _context, final IWebCallbacks iWebCallbacks, String _reason, String _body) {

        String myUrl = AppConstt.BASE_URL_MOBILE + ApiMethod.POST.contactUs;
        this.mContext = _context;
        RequestParams params = new RequestParams();
        params.put("reason", _reason);
        params.put("message", _body);
