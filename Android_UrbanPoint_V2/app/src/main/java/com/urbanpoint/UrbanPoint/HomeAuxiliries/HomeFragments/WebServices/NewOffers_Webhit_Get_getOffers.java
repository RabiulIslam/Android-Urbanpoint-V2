...
public class NewOffers_Webhit_Get_getOffers {
    ...
    public void requestNewOffers(Context _context, final IWebCallbacks iWebCallbacks, int _page, String _sortBy, double _lat, double _lng, boolean _isFavFilterRequired) {
        ...
        if (!_isFavFilterRequired) {
             myUrl = AppConstt.BASE_URL_MOBILE + ApiMethod.GET.getOffers;
            params.put("newOffers", "newOffers");
        }else {
