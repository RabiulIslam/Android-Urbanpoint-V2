...
public class SignUp_WebHit_Get_sendMT {
    ...
    public void requestResendCode(Context _mContext, final IWebCallbacks iWebCallback, final String _isPhone) {

        this.mContext = _mContext;
        String myUrl = AppConstt.BASE_URL_SUBSCRIPTION + ApiMethod.GET.sendMT;
        RequestParams params = new RequestParams();
        params.put("phone", _isPhone);
